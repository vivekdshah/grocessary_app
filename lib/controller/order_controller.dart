...
enum OrderStatusTabs {all, delivered }
class OrderController extends GetxController implements GetxService{
  ...
  Response _apiResponse = const Response();
  ...
  Future<void> startPrinting() async {
    if (_apiResponse.statusCode == 200) {
      platform.invokeMethod('print_receipt', {'data': _apiResponse.body});
    }
  }
  ...
  Future<OrderDetailsModel> getOrderDetails(int orderID) async {
    ...
    if ( apiResponse.statusCode == 200) {
      if(apiResponse.body['order']['order_status'] != 'out_for_delivery') {

        ...
        builder: (authController) {
          return Column(mainAxisAlignment: MainAxisAlignment.start,
            ...
            children: [
             ...
             Container(transform: Matrix4.translationValues(0, -40, 0),child: Column(children: [
               Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center,
                 children: [

                   Text('${authController.profileModel.profile!.fName!} ${authController.profileModel.profile!.lName!}',
                       style: robotoBold.copyWith(fontSize: Dimensions.fontSizeOverLarge)),
                 ],
               ),
               Text(' ${'branch'.tr} : ${authController.profileModel.branch!.name!} ',

    ...
    Container(
      ...
      child: Transform.rotate(
        ...
        child: Directionality(
          ...
          child: SliderButton(
            width: ResponsiveHelper.isSmallTab() ? 200 : ResponsiveHelper.isTab(context) ? 300 :  Get.width - 10,
      ...
      child: Transform.rotate(
        ...
        child: Directionality(
          ...
          child: SliderButton(
            ...
            dismissible: false,
            action: () {
              Get.find<OrderController>().updateOrderStatusTabs(OrderStatusTabs.delivered);
              Get.find<OrderController>().orderStatusUpdate(orderId, 'delivered');
              Get.find<OrderController>().setOrderIdForOrderDetails(orderId, 'delivered','');
              Get.find<OrderController>().getOrderDetails(orderId);
            },

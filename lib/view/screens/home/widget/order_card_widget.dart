                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
                            child: Text(DateConverter.isoStringTodateToDDMMMyyyy(order.deliveryDate!), style: robotoRegular),
                          ),
                          Text(DateConverter.convertTimeToTime(order.deliveryTime!), style: robotoRegular),
